...
public class Mercurio : MonoBehaviour 
{
	...
	void OnGUI(){
		...
		if(label == true)
		{	
			GUI.Box(new Rect(Input.mousePosition.x,Screen.height-Input.mousePosition.y - 25,60,20),"");
			GUI.Label(new Rect(Input.mousePosition.x + 5,Screen.height-Input.mousePosition.y - 25,300,100),"Mercurio");
		}
